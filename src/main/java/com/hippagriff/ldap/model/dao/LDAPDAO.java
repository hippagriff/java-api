package com.hippagriff.ldap.model.dao;
...
public class LDAPDAO
{
    ...
    /**
     * Returns true if the LDAP server is properly connected.
     * 
     * @return
     */
    private boolean isLDAPConnected()
    {
        return ldapServer == null || ldapServer.getLdapConnection() == null
                || !ldapServer.getLdapConnection().isConnected();
    }
